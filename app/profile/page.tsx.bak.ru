...
export default function ProfilePage(){
  ...
  useEffect(()=>{
    try{
      ...
      if (rawWal && m){ try{
        ...
        else if (byUser && typeof byUser === 'object') { cnt = Object.values(byUser).reduce((a:any,v:any)=>a + (Array.isArray(v)?v.length:1), 0); }
  ...
  return (
    <div className="profile-wrap" style={{maxWidth:480, margin:'0 auto 96px', padding:'12px 16px'}}>
      ...
      <section className="mini-two">
        <Link href="/kyc" className="mini-tile">
        ...
        <Link href="/email" className="mini-tile">
      ...
      <div className="list-card">
        ...
        <Row href="/support"  icon={IconChat()} label="Support" />
      </div>
