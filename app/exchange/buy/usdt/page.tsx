...
export default function BuyUsdtPage(){
  ...
  return (
    <div style={{maxWidth:480, margin:'0 auto 96px', padding:'12px 16px', display:'grid', gap:14, color:'#0b1b2b'}}>
      <h1 style={{fontSize:18, fontWeight:900, margin:'0'}}>Оплата USDT</h1>

      <div style={{fontSize:12, color:'#64748b'}}>Сумма к отправке: <b>{isFinite(usdt)&&usdt>0 ? usdt.toFixed(2) : '—'} USDT</b></div>
      ...
      <ul style={{margin:'4px 0 0 18px', lineHeight:1.45, fontSize:12, color:'#475569'}}>
        <li>Отправьте ровно указанную сумму.</li>
        <li>Сеть должна совпадать с адресом (TRC20 или ERC20).</li>
        <li>Зачисление после 1–2 подтверждений сети (демо).</li>
      </ul>
